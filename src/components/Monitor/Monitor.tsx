...
export default function Monitor() {
    ...
    function showRiskDetails(isActive: boolean) {
    ...
    return (
        <div className="flex flex-col flex-[1] w-[100%] z-[0] bg-[#F8F8F8] relative">
            <div className="flex flex-col flex-[1] pr-[20px] pl-[20px]">
                ...
                <MonitorTable showRiskDetails={showRiskDetails} />
            </div>
            {
                isModalActive ?
                    <div className="flex flex-col absolute items-center justify-center h-[100%] w-[100%] z-[1]">
                        <div className="bg-black opacity-[0.2] h-[100%] w-[100%]"></div>
                        <RiskModal showRiskDetails={showRiskDetails} />
                    </div>
                    : null
            }
        </div>
